...
// Check file size
if ($_FILES["sub_cat_img"]["size"] > 5000000) {
...
// if everything is ok, try to upload file
  ...
  $sql = "UPDATE  sub_cat SET  cat_id='$cat_id', subcat_name='$subcat_name', sub_cat_des='$sub_cat_des', 
  sub_cat_img='$target_file' WHERE id='$id'";

		if ($conn->query($sql) === TRUE) {
		
		  echo "<meta http-equiv='refresh' content='0;url=list-sub-category.php'>";
...
<div class="container mt-3 bg-dark text-light" id="customer">
  ...
  <?php 
 	  $id=$_REQUEST['id'];
  	$sql = "SELECT subcat_name,sub_cat_des FROM sub_cat WHERE id='$id'";
