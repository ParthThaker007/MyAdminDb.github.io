...
// if everything is ok, try to upload file
  ...
  $sql = "UPDATE  products SET  sub_cat_id='$sub_cat_id', pname='$pname', pdes='$pdes', 
  pimg='$target_file',pbrand='$pbrand',pprice='$pprice',pcolor='$pcolor' WHERE id='$id'";

		if ($conn->query($sql) === TRUE) {
		
		  header("location:list-sub-category.php");
...
<?php 
 	  $id=$_REQUEST['id'];
  	$sql = "SELECT name,emailid,mno FROM customers WHERE cid='$id'";
